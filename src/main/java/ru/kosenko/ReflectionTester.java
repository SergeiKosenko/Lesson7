    ...
    public static void start(Class<?> c) throws InvocationTargetException, IllegalAccessException {
        ...
        for (Method o : methods) {
            if (o.isAnnotationPresent(Test.class)) {
                ...
                if (prio < 1 || prio > 10) throw new RuntimeException("Приоритет вне диапазона!");
                list.add(o);
            } else if (o.isAnnotationPresent(BeforeSuite.class)) {
                if (before != null) throw new RuntimeException("BeforeSuite ошибка");
                before = o;
            } else if (o.isAnnotationPresent(AfterSuite.class)) {
                if (after != null) throw new RuntimeException("AfterSuite ошибка");
                after = o;
            }
        }
